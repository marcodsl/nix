...
The Privacy category is split into 11 sub-criteria. The IDs below match what `control_matrix_builder.py` emits and `gap_analyzer.py` checks for.

| Criteria | Focus | Key Controls |
|----------|-------|-------------|
| **P1.1** | Notice | Privacy policy, data collection notice, purpose limitation |
| **P2.1** | Choice & Consent | Opt-in/opt-out, consent management, preference tracking |
| **P3.1** | Collection | Minimal collection, lawful basis, purpose specification |
| **P4.1** | Use & Purpose Limitation | Use restrictions, access controls aligned to declared purpose |
| **P4.2** | Retention & Disposal | Retention schedules, secure deletion, disposal certificates |
| **P5.1** | Access Rights | Data subject access requests (DSAR), response timelines |
| **P5.2** | Correction Rights | Rectification workflow, data update logs |
| **P6.1** | Disclosure Controls | Third-party sharing, DPAs, vendor inventory |
| **P6.2** | Breach Notification | Incident response plan, notification templates, regulator timelines |
| **P7.1** | Data Quality | Accuracy verification, correction mechanisms |
| **P8.1** | Monitoring & Enforcement | Privacy program monitoring, complaint handling, audits |
...
- `references/trust_service_criteria.md` — All 5 TSC categories with sub-criteria, control objectives, and evidence examples
- `references/evidence_collection_guide.md` — Evidence types per control, automation tools, documentation requirements
- `references/type1_vs_type2.md` — Detailed comparison, timeline, cost analysis, and upgrade path
