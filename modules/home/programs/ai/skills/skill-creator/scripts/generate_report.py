...
def generate_html(data: dict, auto_refresh: bool = False, skill_name: str = "") -> str:
    ...
    If auto_refresh is True, add a meta refresh tag.
    """
...
<body>
    ...
    <div class="explainer">
        ...
        This page updates automatically as Copilot tests different versions of
        ...
        improve the description; the "Test" score shows performance on held-out
        queries the optimizer hasn't seen. When it's done, Copilot will apply
        the best-performing description to your skill.
    </div>
"""
    ]
    ...
    best_score_source = "(test)" if best_test_score is not None else "(train)"
    html_parts.append(f"""
    <div class="summary">
        <p>
        ...
        <p>
            <strong>Best Score:</strong> {data.get("best_score", "N/A")}
            {best_score_source}
        </p>
        <p>
...
""")
    ...
    <div class="legend">
        ...
        <span class="legend-item">
            <span class="legend-swatch swatch-negative"></span> Should NOT
            trigger
        </span>
        <span class="legend-item">
...
""")
    ...
    for h in history:
        ...
        html_parts.append(f"""            <tr class="{row_class}">
                <td>{iteration}</td>
                <td>
                    <span class="score {train_class}">
                        {train_correct}/{train_runs}
                    </span>
                </td>
                <td>
                    <span class="score {test_class}">
