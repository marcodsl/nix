...
Usage:
    ...
    python control_matrix_builder.py \\
        ...
        "controls": [
            {
                ...
                "tsc": "CC1.1",
                "description": (
                    "Management demonstrates commitment to integrity and ethical "
                    "values"
                ),
                "type": "Preventive",
                "frequency": "Annual",
            ...
            },
            {
                ...
                "tsc": "CC1.2",
                "description": (
                    "Board of directors demonstrates independence and exercises "
                    "oversight"
                ),
                "type": "Preventive",
                "frequency": "Quarterly",
            ...
            },
            {
                ...
                "tsc": "CC1.3",
                "description": (
                    "Management establishes organizational structure, reporting lines, "
                    "and authorities"
                ),
                "type": "Preventive",
                "frequency": "Annual",
            ...
            },
            {
                ...
                "tsc": "CC1.4",
                "description": (
                    "Organization demonstrates commitment to attract, develop, and "
            ...
            },
            {
                ...
                "tsc": "CC1.5",
                "description": (
                    "Organization holds individuals accountable for internal control "
                    "responsibilities"
                ),
                "type": "Preventive",
                "frequency": "Annual",
            ...
            },
            {
                ...
                "tsc": "CC2.1",
                "description": (
                    "Organization obtains and generates relevant quality information "
            ...
            },
            {
                ...
                "tsc": "CC2.2",
                "description": (
                    "Organization internally communicates objectives and "
                    "responsibilities for internal control"
                ),
                "type": "Preventive",
                "frequency": "Quarterly",
                "evidence": (
                    "Internal communications, policy distribution records, training "
                    "materials"
                ),
            },
            {
                ...
                "tsc": "CC2.3",
                "description": (
                    "Organization communicates with external parties regarding matters "
                    "affecting internal control"
                ),
                "type": "Preventive",
                "frequency": "Continuous",
                "evidence": (
                    "Customer notifications, external communication policy, incident "
                    "notices"
                ),
            },
            {
                ...
                "tsc": "CC3.1",
                "description": (
                    "Organization specifies objectives "
                    "to identify and assess risks"
                ),
                "type": "Preventive",
                "frequency": "Annual",
                "evidence": (
                    "Risk assessment methodology, risk register, risk appetite "
                    "statement"
                ),
            },
            {
                ...
                "tsc": "CC3.2",
                "description": (
                    "Organization identifies and analyzes risks to achievement of "
                    "objectives"
                ),
                "type": "Detective",
                "frequency": "Annual",
            ...
            },
            {
                ...
                "tsc": "CC3.4",
                "description": (
                    "Organization identifies and assesses changes that could impact "
                    "internal control"
                ),
                "type": "Detective",
                "frequency": "Quarterly",
            ...
            },
            {
                ...
                "tsc": "CC4.1",
                "description": (
                    "Organization selects and performs ongoing and separate monitoring "
                    "evaluations"
                ),
                "type": "Detective",
                "frequency": "Continuous",
                "evidence": (
                    "Monitoring dashboards, automated alert configurations, review "
                    "logs"
                ),
            },
            {
                ...
                "tsc": "CC4.2",
                "description": (
                    "Organization evaluates and communicates internal control "
                    "deficiencies"
                ),
                "type": "Corrective",
                "frequency": "Quarterly",
                "evidence": (
                    "Deficiency tracking log, management "
                    "reports, remediation plans"
                ),
            },
            {
                "id": "SEC-015",
                "tsc": "CC5.1",
                "description": (
                    "Organization selects and develops control activities that "
                    "mitigate risks"
                ),
                "type": "Preventive",
                "frequency": "Annual",
                "evidence": (
                    "Control matrix, risk treatment plans, control design "
                    "documentation"
                ),
            },
            {
            ...
            },
            {
                ...
                "tsc": "CC5.3",
                "description": (
                    "Organization deploys control activities through policies and "
                    "procedures"
                ),
                "type": "Preventive",
                "frequency": "Annual",
                "evidence": (
                    ...
                    "documents, acknowledgment records"
                ),
            },
            {
                "id": "SEC-018",
                "tsc": "CC6.1",
                "description": (
                    "Logical access security controls over protected information "
                    "assets"
                ),
                "type": "Preventive",
                "frequency": "Continuous",
                "evidence": (
                    ...
                    "configuration, SSO/MFA settings"
                ),
            },
            {
                "id": "SEC-019",
                "tsc": "CC6.2",
                "description": (
                    "User access provisioning based "
                    "on role and business need"
                ),
                "type": "Preventive",
                "frequency": "Continuous",
                "evidence": (
                    "Provisioning tickets, role "
                    "matrix, access request approvals"
                ),
            },
            {
                "id": "SEC-020",
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Deprovisioning tickets, termination checklists, access removal "
                    "logs"
                ),
            },
            {
                ...
                "frequency": "Quarterly",
                "evidence": (
                    "Access review reports, user entitlement listings, review "
                    "sign-offs"
                ),
            },
            {
                ...
                "description": (
                    ...
                    "facilities and protected assets"
                ),
                "type": "Preventive",
                "frequency": "Continuous",
                "evidence": (
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "TLS configuration, encryption "
                    "settings, certificate inventory"
                ),
            },
            {
                "id": "SEC-024",
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Endpoint protection config, software whitelist, malware scan "
                    "reports"
                ),
            },
            {
                ...
                "evidence": (
                    ...
                    "remediation SLAs, patch records"
                ),
            },
            {
                "id": "SEC-027",
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Recovery records, lessons learned "
            ...
            },
            {
                ...
                "frequency": "Annual",
                "evidence": (
                    "Vendor risk assessments, vendor register, SOC 2 reports from "
                    "vendors"
                ),
            },
            {
        ...
        "controls": [
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Capacity monitoring dashboards, scaling policies, resource "
                    "utilization reports"
                ),
            },
            {
            ...
            },
            {
                ...
                "frequency": "Daily",
                "evidence": (
                    "Backup logs, backup success/failure reports, retention "
                    "configuration"
                ),
            },
            {
            ...
            },
            {
                ...
                "frequency": "Quarterly",
                "evidence": (
                    "Failover test records, redundancy "
        ...
        "controls": [
            {
                ...
                "evidence": (
                    ...
                    "labeling standards, data inventory"
                ),
            },
            {
                "id": "CON-002",
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Encryption configuration, TLS "
                    "settings, key management procedures"
                ),
            },
            {
                "id": "CON-004",
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Access control lists, need-to-know "
                    "policy, access review records"
                ),
            },
            {
                "id": "CON-005",
                ...
                "evidence": (
                    ...
                    "alerts/incidents, exception approvals"
                ),
            },
            {
                "id": "CON-006",
            ...
            },
            {
                ...
                "evidence": (
                    ...
                    "logs, retention compliance reports"
                ),
            },
        ],
    },
    "processing-integrity": {
        ...
        "controls": [
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Reconciliation reports, checksum verification, output validation "
                    "logs"
                ),
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Transaction logs, reconciliation "
                    "reports, completeness dashboards"
                ),
            },
            {
                "id": "PRI-004",
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "SLA reports, processing time "
                    "metrics, batch job monitoring"
                ),
            },
            {
                "id": "PRI-006",
        ...
        "controls": [
            {
                ...
                "tsc": "P1.1",
                "description": (
                    "Privacy notice publication and "
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Consent records, opt-in/opt-out "
                    "mechanisms, preference center"
                ),
            },
            {
                "id": "PRV-003",
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Data collection audit, purpose limitation documentation, lawful "
                    "basis records"
                ),
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Data use policy, purpose limitation "
            ...
            },
            {
                ...
                "frequency": "Continuous",
                "evidence": (
                    "Breach response plan, notification "
                    "templates, incident records"
                ),
            },
            {
                "id": "PRV-010",
...
def build_matrix(categories: list[str]) -> list[dict[str, Any]]:
...
# Characters that trigger formula execution when a CSV cell is opened in
# Excel / LibreOffice / Google Sheets. See OWASP "CSV Injection".
...
_MD_HEADER = (
    "| Control ID | TSC | Category | Description | Type | Frequency"
...
def format_markdown(matrix: list[dict[str, Any]]) -> str:
    """Format control matrix as markdown table."""
    lines = ["# SOC 2 Control Matrix", "", _MD_HEADER, _MD_DIVIDER]
    for row in matrix:
        cells = [
            _md_cell(row["control_id"]),
            _md_cell(row["tsc_criteria"]),
            _md_cell(row["category"]),
            _md_cell(row["description"]),
            _md_cell(row["control_type"]),
            _md_cell(row["frequency"]),
            _md_cell(row["evidence_required"]),
            _md_cell(row["owner"]),
            _md_cell(row["status"]),
        ]
...
def format_csv(matrix: list[dict[str, Any]]) -> str:
...
def format_json(matrix: list[dict[str, Any]]) -> str:
    """Format control matrix as JSON."""
    return json.dumps(
        {"controls": matrix, "total": len(matrix)},
        indent=2,
        ensure_ascii=False,
    )
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "SOC 2 Control Matrix Builder — generates control matrices from"
            " selected Trust Service Criteria categories."
        )
    )
    parser.add_argument(
        "--categories",
