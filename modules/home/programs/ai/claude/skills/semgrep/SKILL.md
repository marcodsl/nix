...
metadata:
  ...
  tags: security, static-analysis, semgrep, sast, parallel-scan, vulnerability-scanning
---
...
```bash
uv run ~/.claude/skills/semgrep/scripts/merge_sarif.py $OUTPUT_DIR/raw $OUTPUT_DIR/results/results.sarif
```
