...
metadata:
  author: trailofbits
  source: https://github.com/trailofbits/skills/tree/main/plugins/static-analysis/skills/codeql
  tags: security, static-analysis, codeql, taint-analysis, sarif, vulnerability-scanning
---
...
**Skill resources:** Reference files and templates are located at `~/.claude/skills/codeql/references/` and `~/.claude/skills/codeql/workflows/`.
