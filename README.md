...
- GNU Affero General Public License v3 only - All content under `modules/home/programs/ai/` is licensed under the GNU Affero General Public License v3 only, except for any third-party material present in that subtree. Third-party material remains subject to the original license terms, notices, and attribution requirements provided by the applicable licensors.

See [`LICENSE.md`](LICENSE.md) for the full license mapping and [`modules/home/programs/ai/LICENSE.md`](modules/home/programs/ai/LICENSE.md) for the AGPL-scoped notice and full AGPL-3.0 text.
