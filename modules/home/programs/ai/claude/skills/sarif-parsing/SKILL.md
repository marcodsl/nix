...
metadata:
  ...
  tags: security, static-analysis, sarif, deduplication, scan-results, ci-cd
---
...
For ready-to-use query templates, see [~/.claude/skills/sarif-parsing/resources/jq-queries.md](~/.claude/skills/sarif-parsing/resources/jq-queries.md):
- 40+ jq queries for common SARIF operations
- Severity filtering, rule extraction, aggregation patterns

For Python utilities, see [~/.claude/skills/sarif-parsing/resources/sarif_helpers.py](~/.claude/skills/sarif-parsing/resources/sarif_helpers.py):
